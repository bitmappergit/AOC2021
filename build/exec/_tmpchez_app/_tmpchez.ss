#!/nix/store/bh05h740bp950ia0029d5jl1j740ixpl-chez-scheme-9.5.4/bin/scheme --program
...
(define csegen-2(blodwen-lazy (lambda () (vector (lambda (arg-5468) (lambda (arg-5471) (+ arg-5468 arg-5471))) (lambda (arg-5478) (lambda (arg-5481) (* arg-5478 arg-5481))) (lambda (arg-5488) (PreludeC-45Types-prim__integerToNat arg-5488))))))
(define csegen-17(blodwen-lazy (lambda () (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10112) (PreludeC-45Types-u--null_Foldable_List arg-10112))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_List i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10141) arg-10141)) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10155) (PreludeC-45Types-u--foldMap_Foldable_List i_con-0 u--f arg-10155))))))))))
(define csegen-21(blodwen-lazy (lambda () (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Integer u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--show_Show_Integer u--x)))))))
...
(define Main-with--solve-3708 (lambda (arg-0 arg-1 arg-2) (if (null? arg-1) 0 (let ((e-3 (cdr arg-1))) (let ((sc1 (PreludeC-45Types-u--C-60_Ord_Nat (PreludeC-45Interfaces-sum (csegen-2) (csegen-17) (DataC-45List-take arg-2 arg-0)) (PreludeC-45Interfaces-sum (csegen-2) (csegen-17) (DataC-45List-take arg-2 e-3))))) (cond ((equal? sc1 1) (+ (Main-with--solve-3708 e-3 e-3 arg-2) 1)) (else (Main-with--solve-3708 e-3 e-3 arg-2))))))))
(define Main-main (lambda (arg-1) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (SystemC-45FileC-45ReadWrite-readFile arg-1 "Day1.txt")) (lambda (u--input) (case (vector-ref u--input 0) ((0) (let ((e-6 (vector-ref u--input 1))) (PreludeC-45IO-print (cons arg-1 (cons (lambda (u--x) (SystemC-45FileC-45Error-u--show_Show_FileError u--x)) (lambda (u--d) (lambda (u--x) (SystemC-45FileC-45Error-u--show_Show_FileError u--x))))) e-6))) (else (let ((e-6 (vector-ref u--input 1))) (let ((u--nums (PreludeC-45Types-u--map_Functor_List (lambda (eta-0) (PreludeC-45Cast-u--cast_Cast_String_Nat eta-0)) (DataC-45String-lines e-6)))) (PreludeC-45Interfaces-C-62C-62 (let ((e-8 (car arg-1))) e-8) (PreludeC-45IO-print (cons arg-1 (csegen-21)) (Main-with--solve-3708 u--nums u--nums 1)) (lambda () (PreludeC-45IO-print (cons arg-1 (csegen-21)) (Main-with--solve-3708 u--nums u--nums 3))))))))))))))
...
(define PreludeC-45Interfaces-sum (lambda (arg-2 arg-3 ext-0) (PreludeC-45Interfaces-concat (cons (lambda (arg-8018) (lambda (arg-8021) (PreludeC-45InterfacesC-45NumC-45Semigroup-u--C-60C-43C-62_Semigroup_AdditiveC-36a arg-2 arg-8018 arg-8021))) (PreludeC-45InterfacesC-45NumC-45Monoid-u--neutral_Monoid_AdditiveC-36a arg-2)) arg-3 ext-0)))
...
(define PreludeC-45Interfaces-C-62C-62 (lambda (arg-2 arg-3 arg-4) (let ((e-2 (vector-ref arg-2 1))) ((((e-2 'erased) 'erased) arg-3) (lambda (_-9850) (arg-4))))))
...
(define PreludeC-45IO-u--__Impl_HasLinearIO_IO(blodwen-lazy (lambda () (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8429) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8429 eta-0)))))) (lambda (u--a) (lambda (arg-9131) (lambda (eta-0) arg-9131))) (lambda (u--b) (lambda (u--a) (lambda (arg-9137) (lambda (arg-9144) (lambda (eta-0) (let ((act-17 (arg-9137 eta-0))) (let ((act-16 (arg-9144 eta-0))) (act-17 act-16))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9612) (lambda (arg-9615) (lambda (eta-0) (let ((act-24 (arg-9612 eta-0))) ((arg-9615 act-24) eta-0))))))) (lambda (u--a) (lambda (arg-9626) (lambda (eta-0) (let ((act-51 (arg-9626 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-10790) arg-10790))))))
(define PreludeC-45IO-u--__Impl_HasIO_C-36io (lambda (arg-1) (cons (let ((e-1 (car arg-1))) e-1) (lambda (u--a) (lambda (arg-10728) (let ((e-2 (cdr arg-1))) ((e-2 'erased) arg-10728)))))))
...
(define PreludeC-45IO-print (lambda (arg-2 arg-3) (PreludeC-45IO-putStr (Builtin-fst arg-2) (let ((sc0 (Builtin-snd arg-2))) (let ((e-1 (car sc0))) (e-1 arg-3))))))
...
(define PreludeC-45Cast-u--cast_Cast_String_Nat (lambda (ext-0) (PreludeC-45Types-prim__integerToNat (cast-string-int ext-0))))
...
(define SystemC-45FileC-45ReadWrite-readLinesOnto (lambda (arg-1 arg-2 arg-3 arg-4 arg-5) (if (null? arg-4) (let ((e-1 (car arg-1))) (let ((e-5 (vector-ref e-1 0))) (let ((e-7 (vector-ref e-5 1))) ((e-7 'erased) (vector 1 (cons 0 (PreludeC-45TypesC-45List-reverse arg-2))))))) (let ((e-0 (unbox arg-4))) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (SystemC-45FileC-45ReadWrite-fEOF arg-1 arg-5)) (lambda (_-0) (cond ((equal? _-0 0) (cond ((equal? arg-3 0) (PreludeC-45InterfacesC-45Monad-u--C-62C-62C-61_Monad_ComposeC-40C-40C-46C-32C-36mC-41C-32C-36tC-41 (cons (let ((e-7 (car arg-1))) e-7) (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8429) (case (vector-ref arg-8429 0) ((0) (let ((e-6 (vector-ref arg-8429 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-8429 1))) (vector 1 (u--func e-6))))))))) (lambda (u--a) (lambda (arg-9131) (vector 1 arg-9131))) (lambda (u--b) (lambda (u--a) (lambda (arg-9137) (lambda (arg-9144) (case (vector-ref arg-9137 0) ((0) (let ((e-6 (vector-ref arg-9137 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-9137 1))) (case (vector-ref arg-9144 0) ((1) (let ((e-8 (vector-ref arg-9144 1))) (vector 1 (e-6 e-8)))) (else (let ((e-11 (vector-ref arg-9144 1))) (vector 0 e-11)))))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9612) (lambda (arg-9615) (PreludeC-45Types-u--C-62C-62C-61_Monad_C-40EitherC-32C-36eC-41 arg-9612 arg-9615))))) (lambda (u--a) (lambda (arg-9626) (PreludeC-45Types-u--join_Monad_C-40EitherC-32C-36eC-41 arg-9626)))) (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8429) (case (vector-ref arg-8429 0) ((0) (let ((e-6 (vector-ref arg-8429 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-8429 1))) (vector 1 (u--func e-6))))))))) (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_C-40EitherC-32C-36eC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_C-40EitherC-32C-36eC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10112) (PreludeC-45Types-u--null_Foldable_C-40EitherC-32C-36eC-41 arg-10112))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_C-40EitherC-32C-36eC-41 i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10141) (PreludeC-45Types-u--toList_Foldable_C-40EitherC-32C-36eC-41 arg-10141))) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10155) (PreludeC-45Types-u--foldMap_Foldable_C-40EitherC-32C-36eC-41 i_con-0 u--f arg-10155))))))) (lambda (u--b) (lambda (u--a) (lambda (u--f) (lambda (i_con-0) (lambda (arg-12661) (lambda (arg-12668) (PreludeC-45Types-u--traverse_Traversable_C-40EitherC-32C-36eC-41 i_con-0 arg-12661 arg-12668)))))))))) (SystemC-45FileC-45ReadWrite-fGetLine arg-1 arg-5) (lambda (u--str) (SystemC-45FileC-45ReadWrite-readLinesOnto arg-1 (cons u--str arg-2) 0 (e-0) arg-5))))(else (let ((e-6 (- arg-3 1))) (PreludeC-45Interfaces-C-42C-62 (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8429) (PreludeC-45InterfacesC-45Functor-u--map_Functor_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((sc3 (Builtin-fst (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (func-0) (lambda (arg-8430) (case (vector-ref arg-8430 0) ((0) (let ((e-7 (vector-ref arg-8430 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8430 1))) (vector 1 (func-0 e-7))))))))) (lambda (a-0) (lambda (arg-9131) (vector 1 arg-9131))) (lambda (b-0) (lambda (a-0) (lambda (arg-9137) (lambda (arg-9144) (case (vector-ref arg-9137 0) ((0) (let ((e-7 (vector-ref arg-9137 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9137 1))) (case (vector-ref arg-9144 0) ((1) (let ((e-8 (vector-ref arg-9144 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9144 1))) (vector 0 e-11)))))))))))))))) (let ((e-9 (vector-ref sc3 0))) e-9)) (let ((sc3 (Builtin-snd (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (func-0) (lambda (arg-8430) (case (vector-ref arg-8430 0) ((0) (let ((e-7 (vector-ref arg-8430 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8430 1))) (vector 1 (func-0 e-7))))))))) (lambda (a-0) (lambda (arg-9131) (vector 1 arg-9131))) (lambda (b-0) (lambda (a-0) (lambda (arg-9137) (lambda (arg-9144) (case (vector-ref arg-9137 0) ((0) (let ((e-7 (vector-ref arg-9137 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9137 1))) (case (vector-ref arg-9144 0) ((1) (let ((e-8 (vector-ref arg-9144 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9144 1))) (vector 0 e-11)))))))))))))))) (let ((e-9 (vector-ref sc3 0))) e-9))) u--func arg-8429))))) (lambda (u--a) (lambda (arg-9131) (PreludeC-45InterfacesC-45Applicative-u--pure_Applicative_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (u--b) (lambda (a-0) (lambda (u--func) (lambda (arg-8429) (case (vector-ref arg-8429 0) ((0) (let ((e-7 (vector-ref arg-8429 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8429 1))) (vector 1 (u--func e-7))))))))) (lambda (a-0) (lambda (arg-9132) (vector 1 arg-9132))) (lambda (u--b) (lambda (a-0) (lambda (arg-9137) (lambda (arg-9144) (case (vector-ref arg-9137 0) ((0) (let ((e-7 (vector-ref arg-9137 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9137 1))) (case (vector-ref arg-9144 0) ((1) (let ((e-8 (vector-ref arg-9144 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9144 1))) (vector 0 e-11))))))))))))) arg-9131))) (lambda (u--b) (lambda (u--a) (lambda (arg-9137) (lambda (arg-9144) (PreludeC-45InterfacesC-45Applicative-u--C-60C-42C-62_Applicative_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (u--func) (lambda (arg-8429) (case (vector-ref arg-8429 0) ((0) (let ((e-7 (vector-ref arg-8429 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8429 1))) (vector 1 (u--func e-7))))))))) (lambda (a-0) (lambda (arg-9131) (vector 1 arg-9131))) (lambda (b-0) (lambda (a-0) (lambda (arg-9138) (lambda (arg-9145) (case (vector-ref arg-9138 0) ((0) (let ((e-7 (vector-ref arg-9138 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9138 1))) (case (vector-ref arg-9145 0) ((1) (let ((e-8 (vector-ref arg-9145 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9145 1))) (vector 0 e-11))))))))))))) arg-9137 arg-9144)))))) (SystemC-45FileC-45ReadWrite-fSeekLine arg-1 arg-5) (SystemC-45FileC-45ReadWrite-readLinesOnto arg-1 arg-2 e-6 (box e-0) arg-5)))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) (vector 1 (cons 1 (PreludeC-45TypesC-45List-reverse arg-2)))))))))))))))))
...
(define SystemC-45FileC-45ReadWrite-fGetLine (lambda (arg-1 arg-2) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (let ((e-6 (cdr arg-1))) ((e-6 'erased) (lambda (eta-0) (SystemC-45FileC-45ReadWrite-prim__readLine arg-2 eta-0))))) (lambda (u--res) (let ((sc1 (PreludeC-45EqOrd-u--C-47C-61_Eq_Int (PrimIO-prim__nullAnyPtr (Builtin-believe_me u--res)) (blodwen-toSignedInt 0 63)))) (cond ((equal? sc1 1) (SystemC-45FileC-45Error-returnError arg-1)) (else (SystemC-45FileC-45Support-ok arg-1 (PreludeC-45IO-prim__getString u--res)))))))))))
...
(define SystemC-45Info-isWindows(blodwen-lazy (lambda () (PreludeC-45Types-elem (cons (lambda (arg-528) (lambda (arg-531) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-528 arg-531))) (lambda (arg-538) (lambda (arg-541) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-538 arg-541)))) (blodwen-os) (cons "windows" (cons "mingw32" (cons "cygwin32" '())))))))
...
(define DataC-45String-n--3125-3892-u--linesHelp (lambda (arg-0 arg-1 arg-2) (if (null? arg-1) (if (null? arg-2) '() (if (null? arg-2) (cons (PreludeC-45TypesC-45List-reverse arg-1) '()) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (cond ((equal? e-2 (integer->char 10)) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3))) ((equal? e-2 (integer->char 13)) (if (null? e-3) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3)) (let ((e-5 (car e-3))) (let ((e-6 (cdr e-3))) (cond ((equal? e-5 (integer->char 10)) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-6)))(else (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3))))))))(else (DataC-45String-n--3125-3892-u--linesHelp arg-0 (cons e-2 arg-1) e-3))))))) (if (null? arg-2) (cons (PreludeC-45TypesC-45List-reverse arg-1) '()) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (cond ((equal? e-2 (integer->char 10)) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3))) ((equal? e-2 (integer->char 13)) (if (null? e-3) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3)) (let ((e-5 (car e-3))) (let ((e-6 (cdr e-3))) (cond ((equal? e-5 (integer->char 10)) (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-6)))(else (cons (PreludeC-45TypesC-45List-reverse arg-1) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() e-3))))))))(else (DataC-45String-n--3125-3892-u--linesHelp arg-0 (cons e-2 arg-1) e-3)))))))))
(define DataC-45String-linesC-39 (lambda (arg-0) (DataC-45String-n--3125-3892-u--linesHelp arg-0 '() arg-0)))
...
(PrimIO-unsafePerformIO (Main-main (PreludeC-45IO-u--__Impl_HasIO_C-36io (PreludeC-45IO-u--__Impl_HasLinearIO_IO))))  (collect 4)
